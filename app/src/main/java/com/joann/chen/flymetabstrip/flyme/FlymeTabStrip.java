...
public class FlymeTabStrip extends HorizontalScrollView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        bound.set(left, height - indicatorHeight, right, height);
        canvas.drawRoundRect(bound, px2dip(context, 20f), px2dip(context, 20f), paint);
    }
